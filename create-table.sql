...
-- Schema SGA
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `heroku_b4cfb324509e41f` DEFAULT CHARACTER SET utf8 ;
USE `heroku_b4cfb324509e41f` ;

-- -----------------------------------------------------
-- Table `SGA`.`EMPRESA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`EMPRESA` (
...
-- Table `SGA`.`CONTRATO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`CONTRATO` (
  ...
  CONSTRAINT `fk_CONTRATO_EMPRESA1`
    ...
    REFERENCES `heroku_b4cfb324509e41f`.`EMPRESA` (`ID_EMPRESA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `SGA`.`DOCUMENTO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`DOCUMENTO` (
  ...
  CONSTRAINT `fk_DOCUMENTO_CONTRATO1`
    ...
    REFERENCES `heroku_b4cfb324509e41f`.`CONTRATO` (`ID_CONTRATO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `SGA`.`MATERIAL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`MATERIAL` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`RISCO_BIOLOGICO` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`RISCO_MATERIAL` (
  ...
  CONSTRAINT `fk_RISCO_MATERIAL_MATERIAL1`
    ...
    REFERENCES `heroku_b4cfb324509e41f`.`MATERIAL` (`CODIGO_MATERIAL`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_RISCO_MATERIAL_RISCO_BIOLOGICO1`
    FOREIGN KEY (`RISCO_BIOLOGICO_ID_RISCO_BIOLOGICO`)
    REFERENCES `heroku_b4cfb324509e41f`.`RISCO_BIOLOGICO` (`ID_RISCO_BIOLOGICO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`LISTA_MATERIAL` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`UNIDADE_MEDIDA` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`ITEM_LISTA` (
  ...
  CONSTRAINT `fk_LISTA_ITEM_MATERIAL_UNIDADE_MEDIDA1`
    ...
    REFERENCES `heroku_b4cfb324509e41f`.`UNIDADE_MEDIDA` (`ID_UNIDADE_MEDIDA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_LISTA_ITEM_MATERIAL_LISTA_MATERIAL1`
    FOREIGN KEY (`LISTA_MATERIAL_ID_LISTA_MATERIAL`)
    REFERENCES `heroku_b4cfb324509e41f`.`LISTA_MATERIAL` (`ID_LISTA_MATERIAL`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`DESCARTE_MATERIAL` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b4cfb324509e41f`.`ITEM_DOCUMENTO_DESCARTE` (
  ...
  CONSTRAINT `fk_ITEM_DOCUMENTO_DESCARTE_DOCUMENTO1`
    ...
    REFERENCES `heroku_b4cfb324509e41f`.`DOCUMENTO` (`ID_DOCUMENTO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ITEM_DOCUMENTO_DESCARTE_DESCARTE_MATERIAL1`
    FOREIGN KEY (`DESCARTE_MATERIAL_ID_DESCARTE_MATERIAL`)
    REFERENCES `heroku_b4cfb324509e41f`.`DESCARTE_MATERIAL` (`ID_DESCARTE_MATERIAL`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
